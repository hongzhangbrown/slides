...
\title[prediction and learning]{On PDE approach to some learning problems} % The short title appears at the bottom of every slide, the full title is only on the title page
